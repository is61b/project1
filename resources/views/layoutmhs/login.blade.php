    ...
    <div class="card">
        ...
        <form action="{{ route('login-mhs') }}" method="post">
            ...
            <div class="input-group mb-3">
                <input id="nim" type="nim" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ old('nim') }}" required autocomplete="nim" autofocus placeholder="Masukkan NIM">
                @error('nim')
